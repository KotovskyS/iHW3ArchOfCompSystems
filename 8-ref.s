...
.LFB6:
	...
	cvtss2sd	%xmm0, %xmm0
	movsd	%xmm0, %xmm13		#save h
	pxor	%xmm0, %xmm0
	movsd	%xmm0, %xmm12	#sum
	movq	$0, %r15		#int i = 0
	jmp	.L4
.L5:
	cvtsi2sd	%rbx, %xmm1 #A 
	cvtsi2sd	%r15, %xmm0 # h
	mulsd	%xmm13, %xmm0		# i * h
	addsd	%xmm1, %xmm0		#A + i * h
	movsd	%xmm14, %xmm1	#A + i *h to f
	movq	%xmm15, %rax		#a to f
	movapd	%xmm0, %xmm2
	movq	%rax, %xmm11		#b to f
	movsd	%xmm11, %xmm0
	call	f
	movapd	%xmm0, %xmm1
	movsd	%xmm12, %xmm0
